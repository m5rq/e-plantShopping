...
function ProductList({ onHomeClick }) {
  ...
  // read cart items from Redux so we can show total quantity in navbar
  ...
  // addedToCart looks like { "Snake Plant": true, "Lavender": true, ... }
    ...
    },
    {
      ...
      plants: [
        ...
        },
        {
          ...
          description: 'Repels bugs and smells nice.',
          cost: 20,
        },
        {
          name: 'Basil',
      ...
      plants: [
        {
          ...
          description:
            'Thrives in low light and needs very little water.',
          cost: 25,
        },
        {
          name: 'Pothos',
          ...
          description:
            'Tolerates neglect and grows in many conditions.',
          cost: 10,
        },
        {
          name: 'Snake Plant',
          image:
            'https://cdn.pixabay.com/photo/2021/01/22/06/04/snake-plant-5939187_1280.jpg',
          description: 'Almost impossible to kill.',
          cost: 15,
        },
        {
        ...
        },
        {
          ...
          description:
            'Drought-tolerant, cool shapes and colors.',
          cost: 18,
        },
        {
          name: 'Aglaonema',
  ...
  const handleAddToCart = (product) => {
    // 1. send the product info to Redux
    dispatch(addItem(product));

    // 2. mark button as Added ✅ in local state
